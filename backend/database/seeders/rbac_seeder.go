...
func (s *RbacSeeder) seedPermissions() error {
	permissions := []models.Permission{
		...
		{Code: "leave.workflow.manage", Module: "leave", Action: "manage", Name: "Manage leave approval workflows"},
		...
		{Code: "settings.manage", Module: "settings", Action: "manage", Name: "Manage all system settings"},
		...
		{Code: "performance.reports.view", Module: "performance", Action: "view", Name: "View performance status reports and scores"},
...
func (s *RbacSeeder) seedRolePermissions() error {
	matrix := map[string][]string{
		"staff": {
			...
			"leave.plans.view", "leave.plans.manage",
			"oos.requests.create", "oos.requests.view",
			"attendance.clock", "attendance.view",
			"dashboard.staff", "performance.view", "performance.reports.view",
		},
		"supervisor": {
			"staff.view", "leave.requests.approve", "oos.requests.approve",
			"leave.requests.view", "leave.plans.view", "leave.plans.manage", "leave.plans.view_team",
			"oos.requests.view", "attendance.view",
			"dashboard.supervisor", "performance.view", "performance.reports.view",
		},
		"department_head": {
			...
			"dashboard.department_head", "performance.view", "performance.reports.view",
		},
		"hr_officer": {
			"staff.view", "leave.requests.view", "leave.requests.approve",
			"leave.plans.view", "leave.plans.manage", "leave.plans.view_team",
		...
		"director": {
			...
			"leave.plans.view", "leave.plans.manage", "leave.plans.view_team",
			"oos.requests.view", "oos.requests.approve", "attendance.view",
			"dashboard.director", "performance.view", "performance.reports.view",
		},
		"permanent_secretary": {
			"staff.view", "leave.requests.view", "leave.requests.approve",
			"leave.plans.view", "leave.plans.manage", "leave.plans.view_team",
			"oos.requests.view", "oos.requests.approve", "attendance.view",
			"dashboard.executive", "performance.view", "performance.reports.view",
		},
		"executive_office": {
			"staff.view", "leave.requests.view", "leave.plans.view", "leave.plans.manage",
			"oos.requests.view",
			"attendance.view", "dashboard.executive", "performance.view", "performance.reports.view",
		},
		"admin": {
			...
			"settings.manage",
			"settings.preferences.manage", "settings.lists.manage", "settings.data_sources.manage",
			"settings.email.manage", "settings.notifications.manage", "settings.performance.manage",
			"settings.kpi.manage",
			"kpi.catalog.view", "kpi.catalog.manage", "kpi.assignments.view", "kpi.assignments.manage",
		},
	}
